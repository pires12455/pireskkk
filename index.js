...
usa ${prefix}verificar para verificar a si mesmo e ser capaz de usar o bot.`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, { contextInfo: {"mentionedJid": [num]}})
			} else if (anu.action == 'remove') {
				num = anu.participants[0]
				teks = `Me falta ódio @${num.split('@')[0]} bye Aborto 👋`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	Lxa.on('chat-update', async (mek) => {
      ...
      const is = budy.slice(0).trim().split(/ +/).shift().toLowerCase()
			mess = {
  wait: '⏳ Espera ae cara ja ta quase pronto...',
  success: 'ta ai man',
  Public: '🛡 Modo privado ativado',
  ferr: 'Desculpe ocorreu um erro',
  limitend: 'O tempo está se esgotando ',
  error: {
  stick: 'Experimente depois de um tempo :(',
  Iv: 'Erro de link'
  },
  only: {
    ...
    admin: 'Você deve ser administrador para este comando ',
    Badmin: 'O bot deve ser admin para este comando ',
    daftarB: `Olá, usa *${prefix}verify* ser capaz de usar o bot`
  }
}
...
//---Metadata stiker
			function addMetadata(packname, author) {	
				if (!packname) packname = '♞☞  𝐏𝐈𝐑𝐄𝐒  🐲🏆 Admin'; if (!author) author = 'pires';	
...
┠⊷️ *${prefix}Info*
┃ _Bot informação_
┠⊷️ *${prefix}Proprietário*
┃ _Proprietário do bot_
┠⊷️ *${prefix}Ping*
┃ _Velocidade_
┗━━━━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━━━━
...
┃ _Remover admin_
┠⊷️ *${prefix}Setname*
┃ _Definir o nome do grupo_
┠⊷️ *${prefix}Setdesk*
┃ _Definir descrição do grupo_
┠⊷️ *${prefix}Add*
┃ _Adicionar membro_
┠⊷️ *${prefix}Kick*
┃ _Remover membro_
...
┃ _Delete bot_
┠⊷️ *${prefix}Notif*
┃ _Notificação para todos_
┠⊷️ *${prefix}Welcome*
┃ _On/off bem vindo_
┠⊷️ *${prefix}Delete*
┃ _Remover mensagem do bot_
┗━━━━━━━━━━━━━━━━━━━━
*〘 DIVERSÃO 〙*
┏━━━━━━━━━━━━━━━━━━━━
...
┃ _Informação do anime_
┠⊷️ *${prefix}Neonime (Nombre)*
┃ _Informações de neoanimes_
┠⊷️ *${prefix}Charnime (Nombre)*
┃ _Anime characters_
┠⊷️ *${prefix}Anime*
┃ _Imagem de anime aleatória_
┠⊷️ *${prefix}Loli*
┃ _Imagem aleatória de loli_
┠⊷️ *${prefix}Neko*
┃ _Imagem aleatória de neko_
┗━━━━━━━━━━━━━━━━━━━━
*〘 Percentagem 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷ *${prefix}Rate (Texto)*
...
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
┃ Foto aleatória de um homem
┠⊷️ *${prefix}Cecan*
┃ Foto aleatória de uma mulher
┠⊷️ *${prefix}Wp*
┃ _Imagem aleatoria_
┠⊷️ *${prefix}Img (texto)*
┃ _Imagem_
┠⊷️ *${prefix}Google (Texto)*
┃ _Procurando coisas no google_
┗━━━━━━━━━━━━━━━━━━━━
*〘 Codigos 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Kodebahasa*
...
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Ytmp3 (Link)*
┃ Baixe áudios do YT, é melhor jogar
┠⊷️ *${prefix}Ytmp4 (Link)*
┃ _Transferir vídeo do YT_
┠⊷️ *${prefix}Fb (Link)*
┃ _Transferir do FB_
┠⊷️ *${prefix}Ig (Link)*
┃ _Transferir do IG_
┠⊷️ *${prefix}Scdl (Link)*
┃ _Soundcloud Downloader_
┠⊷️ *${prefix}Tik (Link)*
┃ Descargar Tiktok_
┠⊷️ *${prefix}Pin (Link)*
...
if (args.length < 1) return reply('Digite o que deseja pesquisar ')
tels = body.slice(5)
Lxa.updatePresence(from, Presence.composing)
reply(mess.wait)
try {
...
quoted: mek
  ...
  if (!q.includes('-')) return  reply('Insira a data-mês-ano\n*Exemplo : 09-09-2009*')
  pc = body.slice(9)
  teks1 = pc.split("-")[0];
  teks2 = pc.split("-")[1];
  teks3 = pc.split("-")[2];
...
quoted: mek
  ...
  if (!q.includes('-')) return  reply('Insira a data-mês-ano corretamente\n*Exemplo : 09-09-2009*')
  pc = body.slice(7)
  teks1 = pc.split("-")[0];
  teks2 = pc.split("-")[1];
  teks3 = pc.split("-")[2];
...
quoted: mek
  ...
  hasil = `*Buzina detectada*\n‣ Nome : *${args[0]}*\n‣ Percentagem : *${data.persen}%*\n*${data.desc}*`
  reply(hasil)
...
//--searching lirik
case 'lirik':
  if (args.length < 1) return reply('Escreva o nome da música ')
  if (!isRegister) return reply(mess.only.daftarB)
...
Lxa.sendMessage(from, 'Mudança de nome de grupo ', text, {
  quoted: mek
})
break
...
case 'sholat':
  ...
  if (args.length < 1) return reply('Digite o número da área')
  try {
...
case 'ytmp3':
  ...
  infomp3 = `*Audio!!!*\n‣ Nombre : ${anu.result.title}\n‣ Fonte: ${anu.result.source}\n‣ Tamanho: ${anu.result.size}\n\n_O áudio está sendo enviado, aguarde, caso não chegue baixe pelo link_\n‣ *link* : ${anu.result.link}`
...
case 'ytmp4':
  ...
  if (anu.error) return reply(anu.error)
  infomp3 = `*Video*\n‣ *Nombre* : ${anu.result.title}\n‣ *Fonte* : ${anu.result.source}\n‣ *Tamanho* : ${anu.result.size}\n\n_O vídeo está sendo enviado, caso não chegue baixe pelo link_\n‣ *link* : ${anu.result.url_video}`
  buffer = await getBuffer(anu.result.thumbnail)
...
case 'fb':
  ...
  reply(mess.wait)
  if(!isUrl(args[0]) && !args[0].includes('facebook')) return reply('Formato de link incorreto')
  play = body.slice(4)
  try {
  anu = await fetchJson(`https://mhankbarbar.tech/api/epbe?url=${play}&apiKey=${BarbarKey}`)
  if (anu.error) return reply(anu.error)
  infomp3 = `*Video*\n‣ *Nome* : ${anu.title}\n‣ *Publicação* : ${anu.published}\n‣ *Tamanho* : ${anu.filesize}\n\n_O vídeo está sendo enviado, caso não chegue baixe pelo link_\n‣ *link* : ${anu.result}`
  lagu = await getBuffer(anu.result)
  Lxa.sendMessage(from, lagu, video, {
mimetype: 'video/mp4', filename: `${anu.result.title}.mp4`, quoted: mek
  })
...
case 'scdl':
  ...
  if (args.length < 1) return reply('Envie o link do soundcloud ')
  tels = body.slice(6)
  try {
